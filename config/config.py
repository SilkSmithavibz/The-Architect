...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/SilkSmithavibz/Extra-Plugin",
)
...
LOG_GROUP_ID = getenv("LOG_GROUP_ID", "-1002279841047")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6573727420").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SilkSmithavibz/The-Architect",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", 
    "https://envs.sh/Gik.jpg"
)   

PING_IMG_URL = getenv(
    "PING_IMG_URL", 
    "https://envs.sh/Gis.jpg"
)
